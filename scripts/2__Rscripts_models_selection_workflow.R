...
dff_ectos_network_individual_metrics$mass_tidy<-as.numeric(dff_ectos_network_individual_metrics$mass_tidy)
...
# ######## 4.0. Selected model NETWORKS PREVALENCE STRENGHT  (ZINB)  -------
###_###_###_###_###_##_###_###_###_###_
