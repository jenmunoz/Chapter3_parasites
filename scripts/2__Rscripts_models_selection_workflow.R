...
pp_check(zinb_a_lice_brms_bayes_no_int_degree_prior_p, type = "dens_overlay", ndraws = 100)+ xlim(0, 50)
dev.off()


#ESTIMATES

estimates_plot1<-mcmc_plot(zinb_a_lice_brms_bayes_no_int_degree_prior,prob=0.90, prob_outer=0.95,
                          type="areas") +
