...
# Note this tree is the one we will  use for all analyses by prunning it 1
...
#I am waiting for this to be downloaded but http://vertlife.org/phylosubsets/ seems like is still not working properly ( I emailed them)
...
host_species_tree_manu<- read.nexus("data/phylo_data/tree_pruner/output_bird_parasites.nex") # this is for all species with samples from Manu and Iquitos
